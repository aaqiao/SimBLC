...
caput(prefix + 'SET-NCO-PHA1', 90)
caput(prefix + 'SET-NCO-PHA2', 90)
caput(prefix + 'SET-NCO-PHA3', 90)
caput(prefix + 'SET-NCO-PHA4', 90)
caput(prefix + 'SET-NCO-PHA5', 90)
caput(prefix + 'SET-NCO-PHA6', 90)
caput(prefix + 'SET-NCO-PHA7', 90)
caput(prefix + 'SET-NCO-PHA8', 90)
caput(prefix + 'SET-NCO-PHA9', 90)
caput(prefix + 'SET-NCO-PHA10', 90)
